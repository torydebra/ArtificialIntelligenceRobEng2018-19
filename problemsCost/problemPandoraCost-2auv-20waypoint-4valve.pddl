...
(:init
	...
	(= (distance w7 w8) 2) (= (distance w8 w7) 1)
	...
	(connected w17 w5) (= (distance w17 w5) 6)
	(connected w5 w13) (= (distance w5 w13) 7)
	(connected w13 w3) (= (distance w13 w3) 5)
	(connected w3 w11) (= (distance w3 w11) 4)
	(connected w11 w9) (= (distance w11 w9) 6)
	(connected w9 w19) (= (distance w9 w19) 4)
	(at auv0 w5)
	(at auv1 w3)
