...
(:init
	...
	(= (distance w1 w2) 3) (= (distance w2 w1) 3)
	...
	(= (distance w8 w9) 2) (= (distance w9 w8) 2)
	...
	(= (distance w12 w13) 1) (= (distance w13 w12) 2)
	...
	(connected w11 w1) (= (distance w11 w1) 6)
	(connected w1 w9) (= (distance w1 w9) 6)
	(connected w9 w19) (= (distance w9 w19) 7)
	(connected w19 w13) (= (distance w19 w13) 5)
	(connected w13 w5) (= (distance w13 w5) 6)
	(connected w5 w7) (= (distance w5 w7) 6)
	(connected w7 w17) (= (distance w7 w17) 5)
	(at auv0 w10)
	(at auv1 w12)
	(at auv2 w8)
	(at auv3 w2)
