...
(:init
	...
	(= (distance w11 w12) 1) (= (distance w12 w11) 2)
	...
	(= (distance w18 w19) 2) (= (distance w19 w18) 3)
	(connected w19 w20) (connected w20 w19)
	(= (distance w19 w20) 2) (= (distance w20 w19) 2)
	(connected w20 w21) (connected w21 w20)
	(= (distance w20 w21) 1) (= (distance w21 w20) 1)
	...
	(= (distance w36 w37) 2) (= (distance w37 w36) 1)
	(connected w37 w38) (connected w38 w37)
	(= (distance w37 w38) 1) (= (distance w38 w37) 2)
	(connected w38 w39) (connected w39 w38)
	(= (distance w38 w39) 1) (= (distance w39 w38) 1)
	(connected w39 w40) (connected w40 w39)
	(= (distance w39 w40) 2) (= (distance w40 w39) 3)
	(connected w40 w41) (connected w41 w40)
	(= (distance w40 w41) 3) (= (distance w41 w40) 1)
	...
	(= (distance w43 w44) 1) (= (distance w44 w43) 3)
	...
	(= (distance w46 w47) 3) (= (distance w47 w46) 3)
	...
	(connected w21 w3) (= (distance w21 w3) 5)
	(connected w3 w41) (= (distance w3 w41) 6)
	(connected w41 w7) (= (distance w41 w7) 7)
	(connected w7 w43) (= (distance w7 w43) 5)
	(connected w43 w13) (= (distance w43 w13) 6)
	(connected w13 w29) (= (distance w13 w29) 6)
	(connected w29 w45) (= (distance w29 w45) 5)
	(connected w45 w1) (= (distance w45 w1) 7)
	(connected w1 w11) (= (distance w1 w11) 6)
	(connected w11 w25) (= (distance w11 w25) 7)
	(connected w25 w27) (= (distance w25 w27) 7)
	(connected w27 w23) (= (distance w27 w23) 4)
	(connected w23 w15) (= (distance w23 w15) 7)
	(connected w15 w39) (= (distance w15 w39) 4)
	(connected w39 w33) (= (distance w39 w33) 6)
	(connected w33 w31) (= (distance w33 w31) 7)
	(connected w31 w35) (= (distance w31 w35) 7)
	(at auv0 w5)
	(at auv1 w6)
	(at auv2 w3)
	(at auv3 w35)
