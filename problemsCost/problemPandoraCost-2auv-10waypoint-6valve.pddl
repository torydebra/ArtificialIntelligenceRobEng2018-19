...
(:init
	...
	(= (distance w3 w4) 1) (= (distance w4 w3) 3)
	...
	(= (distance w6 w7) 3) (= (distance w7 w6) 1)
	...
	(connected w7 w3) (= (distance w7 w3) 4)
	(connected w3 w5) (= (distance w3 w5) 6)
	(connected w5 w9) (= (distance w5 w9) 7)
	(at auv0 w5)
	(at auv1 w6)
