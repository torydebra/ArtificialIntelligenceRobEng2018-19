...
(:init
	...
	(= (distance w5 w6) 2) (= (distance w6 w5) 1)
	...
	(= (distance w10 w11) 1) (= (distance w11 w10) 3)
	...
	(connected w9 w5) (= (distance w9 w5) 5)
	(connected w5 w13) (= (distance w5 w13) 6)
	(connected w13 w15) (= (distance w13 w15) 6)
	(connected w15 w7) (= (distance w15 w7) 6)
	(connected w7 w11) (= (distance w7 w11) 6)
	(connected w11 w1) (= (distance w11 w1) 4)
	(at auv0 w6)
	(at auv1 w3)
	(at auv2 w3)
	(at auv3 w0)
