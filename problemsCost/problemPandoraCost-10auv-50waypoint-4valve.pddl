...
(:init
	...
	(= (distance w2 w3) 3) (= (distance w3 w2) 2)
	...
	(= (distance w12 w13) 3) (= (distance w13 w12) 1)
	...
	(= (distance w42 w43) 3) (= (distance w43 w42) 2)
	(connected w43 w44) (connected w44 w43)
	(= (distance w43 w44) 1) (= (distance w44 w43) 2)
	(connected w44 w45) (connected w45 w44)
	(= (distance w44 w45) 1) (= (distance w45 w44) 3)
	...
	(= (distance w48 w49) 2) (= (distance w49 w48) 3)
	(connected w27 w41) (= (distance w27 w41) 5)
	(connected w41 w47) (= (distance w41 w47) 7)
	(connected w47 w15) (= (distance w47 w15) 6)
	(connected w15 w23) (= (distance w15 w23) 4)
	(connected w23 w39) (= (distance w23 w39) 4)
	(connected w39 w13) (= (distance w39 w13) 4)
	(connected w13 w29) (= (distance w13 w29) 5)
	(connected w29 w45) (= (distance w29 w45) 4)
	(connected w45 w31) (= (distance w45 w31) 5)
	(connected w31 w49) (= (distance w31 w49) 6)
	(connected w49 w1) (= (distance w49 w1) 7)
	(connected w1 w11) (= (distance w1 w11) 5)
	(connected w11 w43) (= (distance w11 w43) 4)
	(connected w43 w19) (= (distance w43 w19) 4)
	(connected w19 w25) (= (distance w19 w25) 6)
	(connected w25 w9) (= (distance w25 w9) 6)
	(connected w9 w21) (= (distance w9 w21) 6)
	(connected w21 w33) (= (distance w21 w33) 6)
