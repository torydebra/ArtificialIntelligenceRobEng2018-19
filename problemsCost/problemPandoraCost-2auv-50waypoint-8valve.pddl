...
(:init
	...
	(= (distance w14 w15) 3) (= (distance w15 w14) 3)
	...
	(= (distance w17 w18) 3) (= (distance w18 w17) 2)
	...
	(= (distance w44 w45) 2) (= (distance w45 w44) 2)
	(connected w45 w46) (connected w46 w45)
	(= (distance w45 w46) 3) (= (distance w46 w45) 2)
	...
	(connected w21 w15) (= (distance w21 w15) 5)
	(connected w15 w17) (= (distance w15 w17) 5)
	(connected w17 w29) (= (distance w17 w29) 4)
	(connected w29 w23) (= (distance w29 w23) 7)
	(connected w23 w13) (= (distance w23 w13) 7)
	(connected w13 w31) (= (distance w13 w31) 5)
	(connected w31 w39) (= (distance w31 w39) 5)
	(connected w39 w41) (= (distance w39 w41) 4)
	(connected w41 w37) (= (distance w41 w37) 6)
	(connected w37 w25) (= (distance w37 w25) 5)
	(connected w25 w49) (= (distance w25 w49) 6)
	(connected w49 w5) (= (distance w49 w5) 7)
	(connected w5 w27) (= (distance w5 w27) 6)
	(connected w27 w45) (= (distance w27 w45) 6)
	(connected w45 w47) (= (distance w45 w47) 5)
	(connected w47 w3) (= (distance w47 w3) 5)
	(connected w3 w9) (= (distance w3 w9) 4)
	(connected w9 w19) (= (distance w9 w19) 5)
	(connected w19 w35) (= (distance w19 w35) 4)
	(at auv0 w1)
	(at auv1 w2)
...
(:goal (and
	...
	(valve_goal_completed v397)
	(valve_goal_completed v382)
	...
	(valve_goal_completed v373)
	(valve_goal_completed v230)
	...
	(valve_goal_completed v343)
	(valve_goal_completed v396)
