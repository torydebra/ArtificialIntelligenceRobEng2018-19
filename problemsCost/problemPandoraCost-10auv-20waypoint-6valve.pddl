...
(:init
	...
	(= (distance w2 w3) 2) (= (distance w3 w2) 3)
	(connected w3 w4) (connected w4 w3)
	(= (distance w3 w4) 1) (= (distance w4 w3) 2)
	...
	(connected w7 w9) (= (distance w7 w9) 5)
	(connected w9 w11) (= (distance w9 w11) 4)
	(connected w11 w17) (= (distance w11 w17) 4)
	(connected w17 w13) (= (distance w17 w13) 4)
	(connected w13 w1) (= (distance w13 w1) 4)
	(connected w1 w5) (= (distance w1 w5) 6)
	(connected w5 w3) (= (distance w5 w3) 5)
	(at auv0 w8)
	(at auv1 w5)
	(at auv2 w9)
	(at auv3 w14)
